...
export default function CustomerNavbar() {
        ...
        api.get('/users/me')
            .then(res => {
                if (res.data) {
                    ...
                    const updated = {
                        ...user,
                        fullName: u.user_name || u.fullName || user?.fullName,
    ...
    const nameToDisplay = user?.fullName || user?.user_name || user?.email || 'Customer';
    const firstName = nameToDisplay.split(' ')[0] || 'Customer';
