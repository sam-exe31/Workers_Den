...
│               └── com/
│                   └── workersden/
│                       ├── config/          # App, Cloudinary & MVC configurations
│                       ├── controller/      # REST API Controllers
│                       ├── dto/
│                       │   ├── request/     # Incoming request validation DTOs
│                       │   └── response/    # Outgoing JSON response DTOs
│                       ├── entity/          # JPA entities & Enums
│                       ├── exception/       # Global exception handlers & custom errors
│                       ├── repository/      # Spring Data JPA repositories
│                       ├── security/        # JWT utilities & Spring Security filter chain
...
│       ├── features/        # Feature-specific modules (Worker, Customer, Auth)
...
│   └── architecture.md      # Detailed system architecture & ERD diagrams
│
├── .github/
